...
namespace vitteApp {
    ...
    public partial class studentsDataSet : global::System.Data.DataSet {
        ...
        public partial class studentsDataTable : global::System.Data.TypedTableBase<studentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public studentsRow AddstudentsRow(int ID, string username, string passwd) {
        ...
        public partial class studentsRow : global::System.Data.DataRow {
            ...
            public string passwd {
                get {
                    try {
                        return ((string)(this[this.tablestudents.passwdColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("Значение для столбца \'passwd\' в таблице \'students\' равно DBNull.", e);
                    }
                }
                set {
                    this[this.tablestudents.passwdColumn] = value;
                }
            }
            ...
            public bool IspasswdNull() {
                return this.IsNull(this.tablestudents.passwdColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public void SetpasswdNull() {
                this[this.tablestudents.passwdColumn] = global::System.Convert.DBNull;
            }
        }
...
namespace vitteApp.studentsDataSetTableAdapters {
    ...
    public partial class studentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[students] ([ID], [username], [passwd]) VALUES (@ID, @username," +
                " @passwd)";
            ...
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@passwd", global::System.Data.SqlDbType.Text, 0, global::System.Data.ParameterDirection.Input, 0, 0, "passwd", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::vitteApp.Properties.Settings.Default.studentsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT ID, username, passwd FROM dbo.students";
        ...
        public virtual int Insert(global::System.Nullable<int> ID, string username, string passwd) {
            if ((ID.HasValue == true)) {
